...
const PeoplePage = () => {
    const initialTeamMembers = [
        { id: 1,  name: 'Shubham',  email: 'shubham@zamp.ai',  role: 'System Admin', team: 'Add Team', avatar: 'S', avatarColor: 'bg-gray-800' },
        { id: 2,  name: 'Shaurya',  email: 'shaurya@zamp.ai',  role: 'System Admin', team: 'Add Team', avatar: 'S', avatarColor: 'bg-gray-800' },
        { id: 3,  name: 'Soham',    email: 'soham@zamp.ai',    role: 'System Admin', team: 'Add Team', avatar: 'S', avatarColor: 'bg-gray-800' },
        { id: 4,  name: 'Divy',     email: 'divy@zamp.ai',     role: 'System Admin', team: 'Add Team', avatar: 'D', avatarColor: 'bg-gray-800' },
        { id: 5,  name: 'Sayan',    email: 'sayan@zamp.ai',    role: 'System Admin', team: 'Add Team', avatar: 'S', avatarColor: 'bg-gray-800' },
        { id: 6,  name: 'Vignesh',  email: 'vignesh@zamp.ai',  role: 'System Admin', team: 'Add Team', avatar: 'V', avatarColor: 'bg-gray-800' },
        { id: 7,  name: 'Prashant', email: 'admin@zamp.ai',    role: 'System Admin', team: 'Add Team', avatar: 'P', avatarColor: 'bg-gray-800', isYou: true },
        { id: 8,  name: 'Sujal',    email: 'sujal@zamp.ai',    role: 'System Admin', team: 'Add Team', avatar: 'S', avatarColor: 'bg-gray-800' },
        { id: 9,  name: 'Mehul',    email: 'mehul@zamp.ai',    role: 'System Admin', team: 'Add Team', avatar: 'M', avatarColor: 'bg-gray-800' },
    ];

    const initialInvited = [
        { id: 10, name: 'Sujal',  email: 'sujal@zamp.ai',  role: 'System Admin', avatar: 'S', avatarColor: 'bg-gray-800' },
        { id: 11, name: 'Raghav', email: 'raghav@zamp.ai', role: 'System Admin', avatar: 'R', avatarColor: 'bg-gray-800' },
        { id: 12, name: 'Swati',  email: 'swati@zamp.ai',  role: 'System Admin', avatar: 'S', avatarColor: 'bg-gray-800' },
    ];
    ...
    const handleDeleteInvited = (id) => setInvited(invited.filter(m => m.id !== id));
                                    ...
                                    <td className="py-2.5">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <div className="flex items-center gap-1.5">
                                                ...
                                                {member.isYou && <span className="text-[10px] text-gray-500">(You)</span>}
                                            </div>
                                        </div>
                                    </td>
                                    <td className="py-2.5"><span className="text-xs text-gray-900">{member.email}</span></td>
                                    <td className="py-2.5"><span className="text-xs text-gray-900">{member.role}</span></td>
                                    <td className="py-2.5"><span className="text-xs text-gray-400">{member.team}</span></td>
                    ...
                    <div className="relative bg-white rounded-lg shadow-xl w-full max-w-md mx-4">
                        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200">
                            <div>
                                ...
                                <p className="text-xs text-gray-500 mt-1">Type or paste email addresses, separated by spaces or commas</p>
                            </div>
                        ...
                        <div className="flex items-center justify-end gap-2 px-6 py-4 border-t border-gray-200">
                            <button onClick={() => setShowInviteModal(false)} className="px-4 py-2 text-xs font-medium text-gray-700 hover:bg-gray-100 rounded">
                                Cancel
                            </button>
                            <button onClick={() => setShowInviteModal(false)} className="px-4 py-2 text-xs font-medium text-white bg-gray-900 hover:bg-gray-800 rounded">
                                Invite
                            </button>
                        </div>
                    </div>
